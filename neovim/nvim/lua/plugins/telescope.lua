return {
  {
    ...
    keys = {
      { "<C-p>",         function() require("telescope.builtin").find_files() end,               desc = "Find Files (Ctrl-P)" },
      ...
      { "<leader>sg",    function() require("telescope.builtin").live_grep() end,                desc = "Search (ripgrep)" },
      ...
      { "<leader>sd",    function() require("telescope.builtin").diagnostics() end,              desc = "Diagnostics (workspace)" },
      ...
      { "<leader>f.",    function() require("telescope.builtin").find_files({ hidden = true, no_ignore = true }) end,
